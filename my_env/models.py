...
from .server.data.constants import (
    ED_NURSE_RATIO_DENOMINATOR,
    ED_NURSE_RATIO_NUMERATOR,
    GENERAL_BEDS_TOTAL,
    HALLWAY_CAPACITY,
    ICU_BEDS_TOTAL,
    ICU_NURSE_RATIO_DENOMINATOR,
    ICU_NURSE_RATIO_NUMERATOR,
)
from .server.data.protocols import ProtocolType
